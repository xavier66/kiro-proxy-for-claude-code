...
```bash
# 下载最新版本
wget https://github.com/petehsu/KiroProxy/releases/latest/download/KiroProxy-1.6.3-linux-x86_64

# 添加执行权限
chmod +x KiroProxy-1.6.3-linux-x86_64

# 运行
./KiroProxy-1.6.3-linux-x86_64

# 指定端口
./KiroProxy-1.6.3-linux-x86_64 8081
```

**使用 curl 下载：**

```bash
curl -LO https://github.com/petehsu/KiroProxy/releases/latest/download/KiroProxy-1.6.3-linux-x86_64
chmod +x KiroProxy-1.6.3-linux-x86_64
./KiroProxy-1.6.3-linux-x86_64
```
...
```bash
wget https://github.com/petehsu/KiroProxy/releases/latest/download/kiroproxy_1.6.3_amd64.deb
sudo dpkg -i kiroproxy_1.6.3_amd64.deb
...
```bash
wget https://github.com/petehsu/KiroProxy/releases/latest/download/kiroproxy-1.6.3-1.x86_64.rpm
sudo rpm -i kiroproxy-1.6.3-1.x86_64.rpm
...
```bash
# Intel Mac
curl -LO https://github.com/petehsu/KiroProxy/releases/latest/download/KiroProxy-1.6.3-macos-x86_64
chmod +x KiroProxy-1.6.3-macos-x86_64
./KiroProxy-1.6.3-macos-x86_64

# 如果提示无法验证开发者，运行：
xattr -d com.apple.quarantine KiroProxy-1.6.3-macos-x86_64
```
...
```powershell
# PowerShell 下载
Invoke-WebRequest -Uri "https://github.com/petehsu/KiroProxy/releases/latest/download/KiroProxy-1.6.3-windows-x86_64.exe" -OutFile "KiroProxy.exe"
...
sudo wget -O /opt/kiro-proxy/KiroProxy https://github.com/petehsu/KiroProxy/releases/latest/download/KiroProxy-1.6.3-linux-x86_64
